...
async function loadFacts() {
  const res = await fetch(
    "https://tpbvqnlhvpnzfiglarib.supabase.co/rest/v1/notes",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRwYnZxbmxodnBuemZpZ2xhcmliIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDAwODQyNjMsImV4cCI6MjA1NTY2MDI2M30.XhLPX0FVuX8SBcskdXa2HPFTcl5CgR_xg4SwZtTWlL0",
      },
    }
  );
